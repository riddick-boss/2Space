...
object Routes {
    const val UPCOMING_LAUNCHES_URL = "${BuildConfig.SPACE_DEVS_BASE_URL}launch/upcoming/?limit=15&include_suborbital=true&related=false&hide_recent_previous=true"
